	    ...
	    render: function render() {
	        ...
	        function renderMessage() {
	            if (isLoading) {
	                ...
	                return React.createElement(WeatherMessage, { temp: temp, location: location }); // If temp and location defined
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=4babc0afa5b9303da1ba2af533b0e9b3&units=metric';
